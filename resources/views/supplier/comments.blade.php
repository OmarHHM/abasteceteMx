                ...
                <div class="col-lg-4">
                    <div class="job_sumary">
                        ...
                        <div class="job_content">
                            <ul>
                                @auth
                                <li>Asesor: <span>{{$supplier->contact_name}}</span></li>
                                <li>Telefono: <span>{{$supplier->contact_phoneM}}</span></li>
                                <li>Email: <span>{{$supplier->contact_email}}</span></li>
                                @else                                                                <li>Asesor: <span>Nombre</span></li>
                                <li>Telefono: <span>XX-XX-XX-XXXX</span></li>
                                <li>Email: <span>xxx@xxxx.xxx</span></li>
                    ...
                    <div class="share_wrap">
                        <span>Nuestras redes sociales</span>
                            ...
                            @if( isset($supplier->l_whats_app) )
                                <li>
                                    <a href="{{$supplier->l_whats_app}}" target="_blank"> <i class="fat fa fa-whatsapp"></i>
                                    </a> 
                                </li>
                            @endif
